...
ITStmp$Ergebnis <- factor(ITStmp$Ergebnis, levels = c("nach Hause", 
                                                      ...
                                                      "anderes KH", 
                                                      "Verstorben"))
vergleiche<- list(c("nach Hause", "Pflege/REHA"),
                  c("Pflege/REHA", "anderes KH"),
                  c("anderes KH", "Verstorben"),
                  c("nach Hause", "anderes KH"),
                  c("nach Hause", "Verstorben"),
                  c("Pflege/REHA", "Verstorben"))
